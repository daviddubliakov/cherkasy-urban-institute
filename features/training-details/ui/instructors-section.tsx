  ...
  return (
    <section id="instructors" className="w-full max-w-7xl scroll-mt-8">
      <div className="mb-8 text-center sm:mb-12">
        <h2 className="mb-4 text-2xl font-bold text-gray-900 sm:text-3xl lg:text-4xl">Інструктори вишколу</h2>
...
function InstructorCard({ instructor }: { instructor: InstructorType }) {
  return (
    <div className="flex flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white sm:flex-row">
      <div className="relative h-48 w-full overflow-hidden bg-linear-to-br from-blue-100 to-purple-100 sm:h-auto sm:min-h-[200px] sm:w-40 lg:w-48">
        {instructor.photo ? (
      ...
      <div className="flex flex-1 flex-col justify-center p-5 sm:p-6">
        ...
        <h3 className="mt-2 text-xl font-bold text-gray-900">{instructor.name}</h3>
        <p className="mt-2 leading-relaxed text-gray-600">{instructor.bio}</p>
      </div>
    </div>
  );
}
